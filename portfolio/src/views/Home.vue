...
<v-container fluid>
  <v-row>
    ...
    <v-col cols="6">
      <h5 class="red--text text-darken-4 top">Hi, I'm Tawonga Grant Kanyenda</h5>
      <h1 class="white--text">Software Engineer</h1>
      <p class="grey--text">
        a good graphic designer, backend engineer. <br />
        <br />
        a good graphic designer, backend engineer.
        a good graphic designer, backend engineer.
        a good graphic designer, backend engineer.
        good graphic designer, backend engineer.a
      </p>
    ...
    <div class="first" id="project">
      <v-row>
        <v-col cols="12">
          <div class="child bgColor1">
            ...
            <p class="grey--text ml-3 mt-6">
              UI Designs experience <br /> experience designer
            </p>
          ...
          <div class="child bgColor2">
            ...
            <p class="grey--text ml-3 mt-6">
              shoping caart <br /> hte shpping cart
            </p>
            <v-btn dark text>
              Know More
              <v-icon right>mdi-arrow-right</v-icon>
          ...
          <div class="child bgColor1">
            ...
            <p class="grey--text ml-3 mt-6">
              Brending branding branding <br /> komatu mesa space
            </p>
            <v-btn color="#A7121D" dark text>
              know more
              <v-icon right>mdi-arrow-right</v-icon>
        ...
        <v-col cols="12" class="mt-10">
          <div class="child1">
            <h1 class="red--text text-darken-4 mt-4 number">5</h1>
            ...
            <v-row>
              ...
              <v-col cols="12" class="childcol">
                <div class="child2 padding bgColor1">
                  <h1 class="red--text text--darken-4">5+</h1>
          ...
          <div class="child2">
            <v-row>
              <v-col cols="12" class="childcol">
                <div class="child2 mButton padding bgColor1">
                  <h1 class="red--text text--darken-4">04</h1>
  ...
  <v-col md="3" offset-md="3" id="about">
    ...
    <p class="grey--text">so many projects been featured in</p>
  </v-col>
    ...
    <div class="second">
      ...
      <v-row>
        <v-row>
          <v-col cols="7">
            <h1 class="white--text">
              Let's work together on your next project, try the best<br /> your next project
            </h1>
            <p class="grey--text">
              one two one two testing testing. 
              good stuff right her <br />
            </p>    
          </v-col>
          <v-col cols="5">
